      ...
      <div className="w-[90%] mx-auto">
        <div className="footer-container !justify-between">
          <div>
            ...
            <p
              style={{ color: "#fff", marginBottom: "20px", lineHeight: "1.6" }}
            >
              Passionate about science, tech, and leadership, inspiring
              progress.{" "}
            </p>
              ...
              >
                <span>
                  ...
                  >
                    ...
                    <path
                      fill="currentColor"
                      d="M16.48 11.987a4.54 4.54 0 1 1-4.53-4.54a4.53 4.53 0 0 1 4.53 4.54"
                    />
                  </svg>
                </span>
                <a
