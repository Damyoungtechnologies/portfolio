...
const Footer = () => {
  return (
    <footer id="footer" className="bg-slate-900 dark:bg-black pt-20 pb-10 text-slate-300 border-t border-transparent dark:border-white/5 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-2xl font-extrabold text-white tracking-tight">Damyoung</h2>
            </div>
            <p className="text-slate-400 dark:text-slate-500 leading-relaxed max-w-xs">
              Pioneering digital solutions at the intersection of Science, Tech, and Leadership. 
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              {["Home", "About", "Services", "Portfolio", "Contact"].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase()}`} className="text-slate-400 dark:text-slate-500 hover:text-[#0779e4] flex items-center gap-2 transition-colors group">
          ...
          <div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-slate-400 dark:text-slate-500">Osun State, Nigeria</p>
              </div>
              <div className="flex items-start gap-4">
                <div className="text-[#0779e4] mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                </div>
                <p className="text-slate-400 dark:text-slate-500">+234 803 207 7924</p>
              </div>
              <div className="flex items-start gap-4">
                <div className="text-[#0779e4] mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                </div>
                <p className="text-slate-400 dark:text-slate-500 break-all">samuelayodeji027@gmail.com</p>
              </div>
            </div>
          </div>
        </div>

        <div className="pt-8 border-t border-slate-800 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>© {new Date().getFullYear()} Damyoung Technologies. All rights reserved.</p>
